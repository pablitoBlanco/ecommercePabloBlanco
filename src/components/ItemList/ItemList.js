...
{ id: 2, name: "Man made object", band: "Gogo penguin", price: 2700, photo: "https://img.discogs.com/D8JTyghBLIhOgwPfAsIv4XZ12is=/fit-in/600x600/filters:strip_icc():format(jpeg):mode_rgb():quality(90)/discogs-images/R-8062430-1454420247-1268.jpeg.jpg" }]
 ...
 export const ItemList = () => {
  ...
  return(
     ...
     {discos?.map( ({name, band, photo, price, id } ) => {
      ...
      return  <Item name={name} band={band} cover={photo} price={price} key={id}/>
